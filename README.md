...
[![Go](https://img.shields.io/badge/Go-1.26.6%2B-00ADD8?style=flat-square)](https://go.dev/)
...
To build the latest release from source, install Go 1.26.6 or newer and run:
